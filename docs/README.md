...
- `checklists/before-claiming-traction.md` - keep public traction claims tied to visible evidence
...
- `scripts/check-approval-receipt.py` - check completed receipts for approval and evidence fields
